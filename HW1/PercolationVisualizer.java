...
public class PercolationVisualizer {
    ...
    public static void draw(Percolation perc, int n) {
        ...
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.text(0.25*n, -0.25*n, opened + " open sites");
    ...
    public static void main(String[] args) {
        In in = new In("/Users/wangyouhao/Nutstore/open_class/Algorithms, Part I/hw/src/algs_hw1/percolation_test/input10.txt");      // input file
